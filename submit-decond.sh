if [[ $# == 0 ]]; then
  ...
  t2sub -W depend=afterok:$1 -W group_list=t2g-hp150137 -q S -et 1 -l walltime=03:00:00 -l select=64:mpiprocs=12:mem=48gb -l place=scatter -N decond.run -m ae -M kmtu@esicb.kyoto-u.ac.jp run_decond.sh
else
